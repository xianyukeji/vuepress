  ...
  return {
    computed: {
      ...
      $title () {
        ...
        const titleSplit = this.$site.titleSplit
          ? this.$site.titleSplit
          : (this.$site.themeConfig.titleSplit ? this.$site.themeConfig.titleSplit : ' | ')
        return siteTitle
          ? selfTitle
            ? (selfTitle + titleSplit + siteTitle)
            : siteTitle
          : selfTitle || 'VuePress'
      },
      $description () {
